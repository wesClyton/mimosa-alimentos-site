      ...
      <section className="relative h-[700px] w-full">
        ...
        >
          {skeletonItems.map((_, idx) => {
            ...
            return (
              <SwiperSlide key={`skeleton-${idx}`} className="timeline-slide h-[600px] max-w-[400px]">
                {/* Primeiro item centralizado */}
                {position === 'center' && (
                  <div className="flex h-full translate-y-[2rem] flex-col items-center justify-center">
                    <div className="shimmer-effect relative z-2 h-[160px] w-[160px] rounded-full bg-gray-700"></div>
                    <div className="shimmer-effect mt-4 h-6 w-16 rounded bg-gray-700"></div>
                    <div className="shimmer-effect mt-2 h-5 w-32 rounded bg-gray-700"></div>
                  </div>
                )}
                ...
                {position === 'top' && (
                  <div className="relative flex h-full translate-y-[-9rem] items-start justify-center gap-6 py-40">
                    <div className="flex flex-col items-center">
                      <div className="shimmer-effect mb-2 h-6 w-16 rounded bg-gray-700"></div>
                    ...
                    <div className="mt-[40px] max-w-xs">
                      <div className="shimmer-effect h-5 w-32 rounded bg-gray-700"></div>
                      <div className="shimmer-effect mt-2 h-16 w-full rounded bg-gray-700"></div>
                    </div>
                  </div>
                )}
                ...
                {position === 'bottom' && (
                  <div className="relative flex h-full translate-y-[10rem] items-end justify-center gap-6 py-40">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="shimmer-effect mt-2 h-6 w-16 rounded bg-gray-700"></div>
                    </div>
                    <div className="mt-[40px] max-w-xs">
                      <div className="shimmer-effect h-5 w-32 rounded bg-gray-700"></div>
                      <div className="shimmer-effect mt-2 h-16 w-full rounded bg-gray-700"></div>
